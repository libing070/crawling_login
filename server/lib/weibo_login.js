...
class weiboLogin {
  constructor(userName, userPwd) {
    ...
    this.preLoginUrl = "http://login.sina.com.cn/sso/prelogin.php?entry=weibo&checkpin=1&callback=sinaSSOController.preloginCallBack&rsakt=mod&client=ssologin.js(v1.4.19)";
    // 登录的网页地址
    this.loginUrl = "http://login.sina.com.cn/sso/login.php?client=ssologin.js(v1.4.19)";
    // 初始化预登陆数据为空
    this.preLoginData = '';
    // 初始化验证码为空
    this.pinCode = null;
